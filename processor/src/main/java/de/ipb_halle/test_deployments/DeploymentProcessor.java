 ...
 * annotations are discovered programmatically by this class.
 *
 * @author fblocal
 */

@SupportedSourceVersion(SourceVersion.RELEASE_17)
@SupportedAnnotationTypes(value={"de.ipb_halle.test-deployments.DeploymentElement"})
    ...
    private void buildTestApp(String name) {
        ...
        try {
            JavaFileObject builderFile = processingEnv
                    .getFiler()
                    .createSourceFile(packageName + "." + testPrefix + testName);
